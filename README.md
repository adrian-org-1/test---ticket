...
**IMPORTANT NOTE**: Running ``npm install`` on your local system is **NOT needed** and likely won't work if you'dgfgsfgdsre on the newest version of Node (see Node compatibility chart below)
